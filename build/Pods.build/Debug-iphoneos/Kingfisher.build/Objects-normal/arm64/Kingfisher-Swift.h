...
@property (nonatomic, readonly, copy) NSURL * _Nullable kf_webURL SWIFT_DEPRECATED_MSG("Extensions directly on image views are deprecated. Use `imageView.kf.webURL` instead.", "kf.webURL");
@end
